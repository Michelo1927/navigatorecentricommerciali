...
### 🏬 Scegli il tuo centro commerciale
...
| Centro | Città | Negozi |
|---|---|---|
| **Porta di Roma** | Roma | 199 |
| **GranRoma** | Roma | 93 |

Altri centri in arrivo! 🔜

---

## 📱 Come si usa

1. Apri il sito e scegli il tuo centro commerciale.
2. Scrivi il negozio di **partenza** e quello di **destinazione**.
3. (Opzionale) Aggiungi altre tappe lungo il cammino.
4. Premi **Calcola percorso**.
5. Segui le indicazioni passo dopo passo fino alla meta. ✅

Niente da scaricare, niente registrazione: funziona direttamente dal browser, anche dal telefono.
...
**Fatto con ❤️ per rendere lo shopping più semplice.**
